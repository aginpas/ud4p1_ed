...
class CuentaBancoTest {
	...
	void testSetTitular1() {
		CuentaBanco usuario = new CuentaBanco("Pepe Leproso Canonico", "7969","1192","01","6688325470", "12345678A");
	}
	@Test
	...
	void testComprobarCCC1() {
		CuentaBanco usuario = new CuentaBanco("Pepe Leproso Canonico", "7969","1192","01","6688325470", "12345678A");
		assertEquals(true,usuario.comprobarCCC("79691192016688325470") );
	}*/
	@Test
